...
public class ResumeUtil {
    ...
    public static ResumeSection createAchievement() {
        BulletSection secAch = new BulletSection(ResumeSection.Name.ACHIEVEMENT);
    ...
    public static ResumeSection createQualification() {
        BulletSection section = new BulletSection(ResumeSection.Name.QUALIFICATIONS);
        List<String> achievements = Arrays.asList(
                "1 ach", "2 ach", "3 ach", "4 ach", "5 ach"
        );
...
//    public static BulletSection createBulletSection(ResumeSection.Name sectionName, List<BulletText> bullets) {
